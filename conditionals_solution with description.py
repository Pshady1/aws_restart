# Lab 5: Conditionals
# condtionals in python are functions that enable a command to be actioned
# if the conditions for that command are met.
# There are 3types of conditional functions: if, else and elif
